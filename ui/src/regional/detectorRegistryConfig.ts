...
export type DetectorRegistryConfig = { schema: "bv.detector_registry_config"; version: 1; detectors: DetectorRegistryEntry[] };

export const emptyDetectorRegistryConfig = (): DetectorRegistryConfig => ({ schema: "bv.detector_registry_config", version: 1, detectors: [] });
export const parseDetectorRegistryConfig = (value: unknown): DetectorRegistryConfig => {
    try {
        ...
        return { schema: "bv.detector_registry_config", version: 1, detectors };
