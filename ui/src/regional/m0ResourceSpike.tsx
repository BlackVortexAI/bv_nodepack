...
export function installM0ResourceSpike(nodeType:any,nodeData:any){
    ...
    if(nodeData.name===CONSUMER){const created=nodeType.prototype.onNodeCreated,configured=nodeType.prototype.onConfigure,changed=nodeType.prototype.onConnectionsChange;const upgrade=function(this:any){ensureCanvasVisibility();this.__bvM0ResourceConsumer=true;ensureM0ConsumerInput(this);applyLinkedRemap(this);sanitizeM0SingleSelection(this);["collector_id","resource_id"].forEach(name=>hideWidget(widget(this,name)));installDomRefresh(this,()=>renderPicker(this));renderPicker(this);setTimeout(()=>renderPicker(this),0);};nodeType.prototype.onNodeCreated=function(){const r=created?.apply(this,arguments);queueMicrotask(()=>upgrade.call(this));return r};nodeType.prototype.onConfigure=function(){const r=configured?.apply(this,arguments);queueMicrotask(()=>upgrade.call(this));return r};nodeType.prototype.onConnectionsChange=function(){const previous=linkedCollector(this),r=changed?.apply(this,arguments);queueMicrotask(()=>{applyLinkedRemap(this);sanitizeM0SingleSelection(this);renderPicker(this);refreshCollector(previous);refreshCollector(linkedCollector(this))});return r};return true;}
    if(nodeData.name===MULTI_CONSUMER){const created=nodeType.prototype.onNodeCreated,configured=nodeType.prototype.onConfigure,changed=nodeType.prototype.onConnectionsChange;const upgrade=function(this:any){ensureCanvasVisibility();this.__bvM0ResourceConsumer=true;ensureM0MultiConsumerInputs(this);repairMultiBindingIds(this);applyMultiLinkedRemaps(this);sanitizeM0MultiSelections(this);hideWidget(widget(this,"resource_bindings"));installDomRefresh(this,()=>{applyMultiLinkedRemaps(this);renderMultiPicker(this)});renderMultiPicker(this);[0,50,150].forEach(delay=>setTimeout(()=>{applyMultiLinkedRemaps(this);sanitizeM0MultiSelections(this);renderMultiPicker(this)},delay));};nodeType.prototype.onNodeCreated=function(){const r=created?.apply(this,arguments);queueMicrotask(()=>upgrade.call(this));return r};nodeType.prototype.onConfigure=function(){const r=configured?.apply(this,arguments);queueMicrotask(()=>upgrade.call(this));return r};nodeType.prototype.onConnectionsChange=function(){const r=changed?.apply(this,arguments);queueMicrotask(()=>{applyMultiLinkedRemaps(this);sanitizeM0MultiSelections(this);setMultiDebug(this,Boolean(this.properties?.bvM0DebugVisible),false);renderMultiPicker(this)});return r};return true;}
    return false;
}
