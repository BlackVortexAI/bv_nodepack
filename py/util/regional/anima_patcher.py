# Derived from Comfyui-Anima-Regional-Conditioning.
# Copyright (c) 2026 Vikas Vishwakarma. Licensed under the MIT License.
# See THIRD_PARTY_NOTICES.md in the bv_nodepack repository.
